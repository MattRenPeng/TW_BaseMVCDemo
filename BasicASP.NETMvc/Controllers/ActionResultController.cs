...
namespace BasicASP.NETMvc.Controllers
{
    ...
    public class ActionResultController : Controller
    {
        ...
        public ActionResult Baidu()
        {
            ...
            //var result1 = Redirect("http://www.baidu.com");
            return result;
        }
        ...
        public ActionResult Redirect2Route()
        {
            ...
            return RedirectToRoute(new {  Action="Page" });
        }
        ...
        public ActionResult ScriptResult()
        {
            ...
            // return JavaScript("<script><alert>hi,welcome to .net</alert></script>");
            return returnData;
        }
        ...
        public ActionResult HttpUnauthorizedResult()
        {
            ...
            return new HttpUnauthorizedResult("未认证");
        }
